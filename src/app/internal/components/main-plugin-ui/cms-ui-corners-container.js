...
export class CmsUICornersContainer extends ViewStream {

  constructor(props = {}) {
    props.id='cms-ui-corners-container';
    props.data = CmsUICornersContainer.getCornersData();
    props.template = require('./templates/cms-ui-corners.tmpl.html');
    super(props);
  }
  ...
  static getCornersData(){
    ...
    const svgIcon = CmsUICornersContainer.getSVGCornerIcon();
